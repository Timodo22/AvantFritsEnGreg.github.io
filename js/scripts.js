...
$(function () {
    ...
    $('.hamenu .target').click(function(){
        $('.topnav .menu-icon').click();
    });
    ...
    const target = document.querySelector('#site-menu')
    ...
    document.addEventListener('click', (event) => {
      ...
      if (event.target.id == "menu-toggle-txt") {
          withinBoundaries = true;
      }

       if (event.target.id == "menu-toggle-txt-close") {
          withinBoundaries = true;
      }
      ...
      if (withinBoundaries) {
        ...
        if (open) {
            ...
            $('.hamenu').delay(300).animate({ left: "-100%" });
            $('.topnav .menu-icon .text').removeClass('open');
            $('.topnav .menu-icon').removeClass('active')
...
$(function () {
    ...
    $(document).on('click', '#site-menu a[href^="#"]', function (event) {
    event.preventDefault();
